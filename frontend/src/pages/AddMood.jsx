...
//           {/* Song List */}
//           <ul className="bg-indigo-50 border border-indigo-200 rounded-lg p-4">
//             {songs.length === 0 ? (
//               <p className="text-gray-500 text-sm">No songs added yet.</p>
//             ) : (
//               songs.map((s, i) => (
//                 <li key={i} className="py-1 text-indigo-700 font-medium">
//                   🎵 {s}
//                 </li>
//               ))
//             )}
...
//                        text-lg font-semibold hover:bg-green-600 transition"
//           >
//             Create Mood
//           </button>
//         </form>
