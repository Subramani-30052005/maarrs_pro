...
export default function MoodCard({ mood, onDelete }) {
  return (
  <div className="group relative bg-linear-to-br from-white to-purple-50 shadow-xl rounded-3xl p-6 hover:shadow-2xl transition-all duration-300 border-2 border-purple-100 hover:border-purple-300 overflow-hidden">
    ...
    <div className="relative z-10">
      ...
      {/* Song List */}
      <div className="bg-white/50 backdrop-blur-sm rounded-xl p-4 mb-4 border border-purple-100">
      ...
      <div className="flex items-center gap-2">
        ...
        {/* <Link
          to={`/recommend/${encodeURIComponent(mood.name)}`}
          className="flex-1 px-4 py-2.5 bg-linear-to-r from-green-500 to-emerald-500 text-white rounded-xl text-sm font-bold hover:shadow-lg hover:scale-105 transition-all duration-200 text-center"
        >
           Recommend
        </Link> */}
      </div>
